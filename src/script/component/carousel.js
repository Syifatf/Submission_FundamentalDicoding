    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
       <div class="carousel-inner">
         <div class="carousel-item active">
           <img id="cr" class="d-block w-100" src="../src/assets/image/1.png" alt="First slide">
         </div>
         <div class="carousel-item">
           <img id="cr" class="d-block w-100" src="../src/assets/image/2.png" alt="Second slide">
         </div>
         <div class="carousel-item">
           <img id="cr" class="d-block w-100" src="../src/assets/image/5.png" alt="Third slide">
         </div>
       </div>
